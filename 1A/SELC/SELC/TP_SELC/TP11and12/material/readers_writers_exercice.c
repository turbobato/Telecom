...
int main(int argc, char *argv[]) {
  ...
  lock_for_starvation = sem_open(LOCK_AGAINST_STARVATION_NAME, O_CREAT, 0644, initial_sem_counter);
  if (lock_for_starvation == SEM_FAILED) {
    perror("initialization of lock for starvation failed");
    exit(1);
  }
