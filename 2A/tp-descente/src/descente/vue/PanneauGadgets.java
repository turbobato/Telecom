...
public class PanneauGadgets extends Box {
	...
	protected JButton validerPb  = new JButton("Valider le probleme");
	protected JLabel  indication = new JLabel("Choisissez un probleme");
	...
	protected JLabel lesLambda1 = new JLabel("  ");
	protected JLabel lesLambda2 = new JLabel("  ");
	...
	protected PanneauGadgets(Vue vue){
		...
		panneau.add(lesLambda1);
		panneau.add(lesLambda2);
		this.add(panneau);
