...
/**
 * Modelise un bord du domaine ; cela peut etre une droite, une demi-droite, un segment, ou etre vide
 *
 */
public class Bord {
	private Couple[] extr = new Couple[2]; // contient les deux extrémités quand il s'agit d'un segment, 
	...
	public Bord(Domaine domaine, Contrainte c) {
		...
		// calcule les intersections avec les autres droites
	...
	/**
	 * @return - les deux extremites quand il s'agit d'un segment, 
	 * <br>- l'extremite dans la case d'indice 0 si c'est une demi-droite, null dans l'autre case
