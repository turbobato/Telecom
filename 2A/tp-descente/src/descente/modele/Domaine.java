...
/**
 * Modelise un domaine defini par un ensemble de contraintes affines
 * On suppose qu'il n'existe pas trois droites determinant les contraintes qui se coupent en un meme point.
 */
public class Domaine {
	...
	/**
	 * Cherche si un point donne est sur un bord du domaine
	...
	/**
	 * Etant donne deux contraintes, cherche si l'intersection de leurs droites frontieres est un coin du domaine
	 * @param c1 la premiere contrainte
	...
	/**
	 * Recherche si un point donne est en un coin du domaine
	...
	public Contrainte[] estCoin(Couple P) {
		...
		if (!this.estFeasible(P)) return null;
	 ...
	 * est sur un des bords, elle n'est pas consideree comme intersection
	...
	public double intersection(Couple P0, Couple d) {
		...
		for (Contrainte c : contraintes) {
			...
			if (t >= 0) {
				...
				if (this.estFeasible(P)) return t;
			}
		}
		return -1;
	}
	...
	/**
	 * Supprime les contraintes qui ne contribuent pas a delimiter le domaine
	 */
	private void epurer() {
		Bord aRetire;
	...
	/**
	 * Calcule les coins du domaine ; chaque coin est un Couple contenant les coordonnees du coin
	 */
	...
	/**
	 * Calcule le minimum et le maximum des abscisses du domaine ainsi que des ordonnees.
	 */
	...
	/**
	 * @return la liste des contraintes du domaine, apres suppression des contraintes inutiles
	 */
	...
	/**
	 * @return la liste des bords du domaine
	 */
	...
	/**
	 * @return la liste des coins du domaine ; chaque coin est un Couple contenant les coordonnees du coin
	 */
	...
	/**
	 * @return true si le domaine est vide, false sinon
	 */
	...
	/**
	 * @return la plus grande ordonnee des points du domaine
	 */
	...
	/**
	 * @return la plus petite ordonnee des points du domaine
	 */
